...
interface ClientsIndexContentProps {
    resource: string;
}

export default function ClientsIndexContent({ resource }: ClientsIndexContentProps) {
                    ...
                    },
                    {
                        ...
                        cell: ({ row }: { row: Row<never> }) => {
                            ...
                            return (
                                <Badge
                                    className={cn(
                                        'border-0 text-xs font-medium shadow-lg',
                                        rowModel.status_meta.bgColor,
                                        rowModel.status_meta.textColor,
                                    )}
                                >
                                    {  rowModel.status_meta.label}
                                </Badge>
                            );
                        },
                    },
