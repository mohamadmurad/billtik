                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                ...
                                <MSelect
                                    ...
                                    apiUrl={
                                        data.client_type === 'ppp'
                                            ? route('company.ppp.clients.search')
                                            : route('company.hotspot.clients.search')
                                    }
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                {activeSubscriptionId && (
                                    <option value={activeSubscriptionId}>Active Subscription</option>
                                )}
                            </select>
                        </div>
                        <div className="space-y-2">
                            ...
                            {activeSubscriptionId && (
                                <p className="text-muted-foreground text-xs">Active subscription selected automatically.</p>
                            )}
                        </div>
                    </div>
