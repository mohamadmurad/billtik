...
import { Calendar, CheckCircle2, Clock, CreditCard, DollarSign, Info, Minus, Plus, Receipt, Router, User, XCircle } from 'lucide-react';
                ...
                <div className="mx-auto max-w-6xl px-4 py-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            <div className="border-b border-gray-200 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 px-8 py-6 dark:border-gray-700 dark:from-blue-900/30 dark:via-indigo-900/30 dark:to-purple-900/30">
                                <h2 className="flex items-center gap-3 text-xl font-bold text-gray-900 dark:text-gray-100">
                                    <User className="h-6 w-6 text-blue-600" />
                                    Client Information
                                </h2>
                                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Select the router and client for this invoice</p>
                            </div>
                            <div className="p-6">
                                ...
                                {data.client_id ? (
                                                ...
                                                <div className="border-b border-gray-100 px-6 py-6 dark:border-gray-700">
                                                    <div className="grid grid-cols-12 items-center gap-4">
                                                        ...
                                                        <div className="col-span-2">
                                                            <div className="space-y-3">
                                                                <span className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 px-4 py-3 text-sm font-bold text-white shadow-lg">
                                                                ...
                                                                {activeSubscription && (
                                                                    <div className="text-xs text-gray-500 dark:text-gray-400">
                                                                        <div>Start: {activeSubscription.start_date || ''}</div>
                                                                        <div>Current End: {activeSubscription.end_date || ''}</div>
                                                                    </div>
                                                                )}
                                                            </div>
                                                        </div>
                                                            ...
                                                            {activeSubscriptionId ? (
                                                                <div className="space-y-2">
                                                                    <div className="font-bold text-gray-900 dark:text-gray-100">
                                                                        {activeSubscription.profile?.name || 'Active Subscription'}
                                                                    </div>
                                                                ...
                                                                <Select
                                                                    ...
                                                                    onValueChange={(e) => setData('profile_id', e)}
                                                                >
                                                                    <SelectTrigger>
                                            ...
                                            {generatedEndDate && (
                                                <div className="flex items-center gap-2 rounded-lg bg-white px-4 py-2 shadow-sm dark:bg-gray-800">
                                                    ...
                                                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                                                        {activeSubscription ? 'New End Date:' : 'Service Period End:'}
                                                        <span className="ml-2 font-bold text-blue-600 dark:text-blue-400">{generatedEndDate}</span>
                                                    </span>
                                                </div>
                                            )}
                                        </div>
                                    ...
                                    <div className="flex items-center justify-center py-16">
                                        <div className="text-center">
                                            ...
                                            <h3 className="mt-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Select a Client</h3>
                                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                                Choose a router and client to configure the invoice details
                                            </p>
                                        </div>
                                    </div>
                                )}
                    ...
                    {data.client_id && (
                        <div className="mt-8 rounded-xl bg-blue-50/50 p-6 dark:bg-blue-900/20">
                            <div className="flex items-start gap-3">
                                <Info className="mt-0.5 h-5 w-5 text-blue-500" />
                                <div className="space-y-2 text-sm text-blue-800 dark:text-blue-200">
                                    <p className="font-semibold">Important Notes:</p>
                                    <ul className="space-y-1 text-blue-700 dark:text-blue-300">
                                        <li>• The invoice will be automatically numbered when created</li>
                                        <li>
                                            •{' '}
                                            {activeSubscription
                                                ? 'Subscription will be extended from current end date'
                                                : 'New subscription will start from issue date'}
                                        </li>
                                        <li>• Client will receive notification once the invoice is generated</li>
                                        <li>• Payment processing will activate the subscription automatically</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
