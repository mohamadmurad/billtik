...
export default function Show() {
    ...
    const enable = () => router.post(route('company.hotspot.clients.enable', model.id));
    const disable = () => router.post(route('company.hotspot.clients.disable', model.id));
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                        <div className="grid gap-2">
                            <MSelect
                                ...
                                apiUrl={route('company.hotspot.profiles.search', { is_synced: 1 })}
